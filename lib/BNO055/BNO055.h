...
/*BNO055-quaternion-Float w,x,y,z*/
struct bno055_quaternion_float {
								float w;
								float x;
								float y;
								float z;
...
/*BNO055-Linear Accel-Float x,y,z*/
